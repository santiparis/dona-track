...
class AplicacionTest {
    ...
    void sePuedeAgregarUnaPersonaHumana() {
        // Arrange
        assertEquals(0, aplicacion.getPersonas().size());

        // Act
        aplicacion.agregarPersona(donanteHumano);

        // Assert
        assertEquals(1, aplicacion.getPersonas().size());
        Optional<Persona> donanteRecuperado = aplicacion.buscarPersonaPorDocumento("12345678");
    ...
    void sePuedeAgregarUnaPersonaJuridica() {
        ...
        // Act
        aplicacion.agregarPersona(donanteJuridico);

        // Assert
        assertEquals(1, aplicacion.getPersonas().size());
        Optional<Persona> donanteRecuperado = aplicacion.buscarPersonaPorDocumento("30-12345678-9");
        assertTrue(donanteRecuperado.isPresent());
    ...
    void sePuedeActualizarUnaPersonaHumana() {
        ...
        // Act
        aplicacion.actualizarPersona("12345678", donanteActualizado);
    ...
    void sePuedeActualizarUnaPersonaJuridica() {
        ...
        // Act
        aplicacion.actualizarPersona("30-12345678-9", donanteActualizado);
    ...
    void sePuedeEliminarUnaPersonaHumana() {
        ...
        // Act
        aplicacion.eliminarPersona("12345678");
    ...
    void sePuedeEliminarUnaPersonaJuridica() {
        ...
        // Act
        aplicacion.eliminarPersona("30-12345678-9");
    ...
    @Test
    void importarPersonasDesdeCSV_CreaNuevaPersonaHumana_SiNoExiste() throws IOException {
        // Arrange
        // Pre-condición: No hay donantes
        assertEquals(0, aplicacion.getPersonas().size());

        // Act
        aplicacion.importarPersonasDesdeCSV("donantes_solo_persona_humana.csv");

        // Assert
        assertEquals(6, aplicacion.getPersonas().size());

        // El donante existe
        Optional<Persona> donanteOpt = aplicacion.buscarPersonaPorEmail("ananavarro3658@yahoo.com");
    ...
    @Test
    void importarPersonasDesdeCSV_CreaNuevaPersonaJuridica_SiNoExiste() throws IOException {
        // Arrange
        // Pre-condición: No hay donantes
        assertEquals(0, aplicacion.getPersonas().size());

        // Act
        aplicacion.importarPersonasDesdeCSV("donantes_solo_persona_juridica.csv");

        // Assert
        assertEquals(6, aplicacion.getPersonas().size());

        // El donante existe
        Optional<Persona> donanteOpt = aplicacion.buscarPersonaPorEmail("santafeindustrial8180@yahoo.com");
        assertTrue(donanteOpt.isPresent());
    ...
    @Test
    void importarPersonasDesdeCSV_ActualizaPersona_SiYaExiste() throws IOException {
        ...
        aplicacion.agregarPersona(donanteExistente);
    ...
    @Test
    void agregarPersona_EnviaEmailDeBienvenida() {
        // Arrange
        ...
        PersonaHumana nuevoPersona = new PersonaHumana(
                "Nuevo", "Persona", 40, TipoDoc.DNI, "40123456", Genero.MASCULINO, "Calle Nueva 456",
                contactos, contactos.get(0), usuario
        );

        // Act
        aplicacion.agregarPersona(nuevoPersona);
